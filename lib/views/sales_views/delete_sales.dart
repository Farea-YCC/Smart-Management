...
class DeleteSales extends StatefulWidget {
  DeleteSales({Key? key, required this.testId}) : super(key: key);
  final int testId;
  @override
  State<DeleteSales> createState() => _DeleteSalesState();
}

class _DeleteSalesState extends State<DeleteSales> {
  bool loading = false;
                  ...
                  :Container(
                    ...
                    TextButton(onPressed: ()async{
                      try {
                        ...
                        var res= await SalesRepository().deleteFromDb(widget.testId);
                        if(res){
                          setState(() {
                            loading = false;
                            isError = false;
