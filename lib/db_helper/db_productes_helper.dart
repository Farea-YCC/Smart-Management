...
// SQL statmant
String _producteTbl = 'CREATE TABLE ${DbTables.Productes} (Id INTEGER PRIMARY KEY AUTOINCREMENT, productName TEXT, Quantity INTEGER, purchasePrice INTEGER, salePrice  INTEGER, Description  TEXT)';

// database table
class DbTables{
  static const String Productes = "Productes";
}
...
// fun initialize Database
  Future<Database> _initializeDatabase() async {
    ...
    final file = File(p.join(dbFolderDir.path, 'Productes.db'));
    var producteDb = await openDatabase(
        file.path,
        version: dbVersion,
