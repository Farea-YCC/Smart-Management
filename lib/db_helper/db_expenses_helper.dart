// ignore_for_file: unnecessary_null_comparison, unnecessary_brace_in_string_interps, avoid_print, prefer_interpolation_to_compose_strings
...
// SQL statmant
String _expenseTbl =
    'CREATE TABLE ${DbTables.Expenses} (Id INTEGER PRIMARY KEY AUTOINCREMENT, exchangeDestination TEXT, amountSpent INTEGER, dateOfExchange TEXT)';
...
// fun initialize Database
  Future<Database> _initializeDatabase() async {
    ...
    final file = File(p.join(dbFolderDir.path, 'Expenses.db'));
    var expenseDb = await openDatabase(file.path,
        version: dbVersion,
