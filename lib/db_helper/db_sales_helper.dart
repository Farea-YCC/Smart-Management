...
// SQL statmant
String _saleTbl = 'CREATE TABLE ${DbTables.Sales} (Id INTEGER PRIMARY KEY AUTOINCREMENT, productName TEXT, Quantity INTEGER, amountPaid INTEGER, remainingAmount INTEGER, Discount INTEGER, customerName TEXT, dateOfAmount TEXT)';
...
// fun initialize Database
  Future<Database> _initializeDatabase() async {
    ...
    final file = File(p.join(dbFolderDir.path, 'Sales.db'));
    var saleDb = await openDatabase(
        file.path,
        version: dbVersion,
